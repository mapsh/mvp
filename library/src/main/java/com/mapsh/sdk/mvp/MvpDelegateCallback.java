...
/**
 * The MvpDelegate callback that will be called from  {@link MvpFragmentDelegate} .
 * <p>
 * Created by mapsh on 16/4/28.
 */
interface MvpDelegateCallback<V extends IMvpView, P extends IMvpPresenter<V>> {
    /**
     ...
     * This boolean flag is used for {@link IMvpPresenter#detachView(boolean)}
